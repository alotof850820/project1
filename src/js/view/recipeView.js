...
//使用繼承class
//每個view都有自己私有方法和屬性
//不能調用controller任何功能!!(解決:將controller功能視為參數傳至訂閱者函數來執行)

//導入未經parcel前的圖片位子
import icons from '../../img/icons.svg'; //console.log(icons);//parcel後的途徑
import { Fraction } from 'fractional';
import { View } from './View';

class RecipeView extends View {
  _parentElement = document.querySelector('.recipe');
  _errorMessage = `無此資料，請重新查詢!`;
  _message = ``;

  //網址hash id發生改變或load即執行
